    ...
    public function acceptCourse($course_id)
    {
        ...
        foreach ($classes as $class) {
            ...
            $postInput = [
                ...
                'timezone' => 90,
                'start_time' => Carbon::parse($class->start_time)->setTimezone('Asia/Karachi')->format('g:i a'),
                'end_time' =>  Carbon::parse($class->end_time)->setTimezone('Asia/Karachi')->format('g:i a'),
                'date' => Carbon::parse($class->start_date)->setTimezone('Asia/Karachi')->format('Y-m-d'),
                'currency' => "USD",
                'ispaid' => null,
                'is_recurring' => 0,
                'repeat' => 0,
