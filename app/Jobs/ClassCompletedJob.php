...
class ClassCompletedJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $data = array('email.rescheduleclass' =>  $user_email, 'custom_message' =>  $custom_message, 'class' => $this->class);
        ...
        $notification->type = "App\Events\ClassCompletedEvent";
