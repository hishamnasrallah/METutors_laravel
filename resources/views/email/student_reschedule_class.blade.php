                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if ($user->role_name == 'teacher')
                                ...
                                <p>Your student <b>{{ $class->student->first_name }}</b> SIN
                                    <b>{{ $class->student->id_number }}</b> has rescheduled a class on you course
                            ...
                            @elseif ($user->role_name == 'student')
                                ...
                                <p>You have rescheduled a class with <b>{{ $class->course->teacher->first_name }}</b> TIN <b>{{ $class->course->teacher->id_number }}</b> on
                                    your
