                ...
                <div class="col-md-8">
                    <div class="card">
                        @if ($user->role_name == 'teacher')
                            <div class="card-body">
                                ...
                                <p>Your student <b>{{ $assignment->course->student->first_name }}</b> SIN
                                    <b>{{ $assignment->course->student->id_number }}</b> has submitted their assignment for
                                    ...
                                    turnaround on grading and providing
                                    meaningful feedback to help your student.
                                </p>
                        ...
                        @if ($user->role_name == 'student')
                            <div class="card-body">
                                <p>Hi <b>{{ $user->first_name }},</b> </p>
                                <p>You have successfully submitted your assingment for your course
