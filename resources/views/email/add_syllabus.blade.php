                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        @if ($user->role_name == 'student')
                            <div class="card-body">
                                <p>Hi <b>HR,</b> </p>
                                <p>Your teacher <b>{{ $resource->class->teacher->first_name }}</b> TIN
                                    <b>{{ $resource->class->teacher->id_number }}</b> has added new resources for your
                                    course <b>{{ $resource->class->course->course_name }}</b> ID
                                    <b>{{ $resource->class->course->course_code }}</b>, booking number
                                    <b>{{ $resource->class->course->course_order->booking_id }}</b>. You can view and
                                    download the resources on your dashboard.
                                </p>
                                <p>Regards,</p>
