                    ...
                    <div class="card">
                        @if ($user->role_name == 'teacher')
                            <div class="card-body">
                                ...
                                <p>You have a class with <b>{{ $class->student->first_name }}</b> SIN <b>{{ $class->student->id_number }}</b> tomorrow for <b>{{ $class->course->course_name }}</b> ID <b>{{ $class->course->course_code }}</b> at TIME <b>{{ $class->start_time }}</b>. </p>
                        ...
                        @if ($user->role_name == 'student')
                            <div class="card-body">
                                ...
                                <p>You have a class with <b>{{ $class->teacher->first_name }}</b> TIN
                                    <b>{{ $class->teacher->id_number }}</b> tomorrow for
